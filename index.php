...
<!-- bylem tu -->
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
          <ul class="navbar-nav w-100 justify-content-center">
           ...
           <!-- panel adm -->
          <a href="./backrooms"><img src="./resources/pig.jpeg" style="height:50px;" /></a>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h3 style="margin-left:50px;margin-right:50px;padding:20px;"> Najnowsza aktualność: </h3>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <a class="btn btn-outline-primary text-center" style="width:35%;margin: 0px auto;font-size:22px;" href="./sklep">Zobacz pełną ofertę</a>
      </div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="row" style="margin-bottom:100px;">
        ...
        <div class="col-md-4 d-flex justify-content-center">
          <a class="btn btn-outline-primary text-center" style="width:400px;font-size:22px;" href="https://twitter.com/biscuitmyham"><img src="https://www.freepnglogos.com/uploads/twitter-logo-png/twitter-logo-vector-png-clipart-1.png" style="height:64px;width:64px;margin-right:25px;" />Twitter</a>
        </div>
        <div class="col-md-4 d-flex justify-content-center">
